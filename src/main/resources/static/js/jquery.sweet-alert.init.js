!function (t) {
    ...
    e.prototype.init = function () {
        t("#sa-basic").on("click", function () {
            ...
            swal({title: "Custom animation with Animate.css", animation: !1, customClass: "animated tada"})
            ...
            swal({title: "Auto close alert!", text: "I will close in 2 seconds.", timer: 2e3}).then(function () {
            }, function (t) {
            ...
            swal({
                ...
                swal({type: "success", title: "Ajax request finished!", html: "Submitted email: " + t})
            })
