...
b,c,e){e.action.call(b.button(c),a,b,c,e);d(b.table().node()).triggerHandler("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/buttons-action.dt",[b.button(c),b,c,e])},j=d("<"+c.tag+"/>").addClass(c.className).attr("tabindex",this.s.dt.settings()[0].iTabIndex).attr("aria-controls",this.s.dt.table().node().id).on("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/click.dtb",function(b){b.preventDefault();!j.hasClass(c.disabled)&&a.action&&q(b,h,j,a);j.blur()}).on("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/keyup.dtb",function(b){b.keyCode===13&&!j.hasClass(c.disabled)&&a.action&&q(b,h,j,a)});"a"===c.tag.toLowerCase()&&j.attr("href","#");
