...
!function (t, s, e, n) {
    ...
    var o = {
        ...
        useURLhash: !0,
        showStepURLhash: !0,
        lang: {next: "Tiếp theo", previous: "Quay lại"},
        toolbarSettings: {
    ...
    t.extend(i.prototype, {
        init: function () {
            ...
            for (var t = this.current_index - 1, s = t; s >= 0; s--) if (!this.steps.eq(s).parent("li").hasClass("disabled") && !this.steps.eq(s).parent("li").hasClass("hidden")) {
                t = s;
                break
            }
            if (0 > t) {
            ...
            var e = this, n = this.steps.eq(this.current_index), i = "", o = this.steps.eq(s),
            ...
            if (!(a && a.length > 0) || o.data("has-content") && this.options.contentCache) this._transitPage(s); else {
                var r = o.length > 0 ? t(o.attr("href"), this.main) : null, h = t.extend(!0, {}, {
                    url: a,
                    type: "POST",
                    data: {step_number: s},
                    dataType: "text",
            ...
            var e = this, n = this.steps.eq(this.current_index), i = n.length > 0 ? t(n.attr("href"), this.main) : null,
                o = this.steps.eq(s), a = o.length > 0 ? t(o.attr("href"), this.main) : null, r = "";
