(function(g){"function"===typeof define&&define.amd?define(["jquery","https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/datatables.net","datatables.net-buttons"],function(j){return g(j,window,document)}):"object"===typeof exports?module.exports=function(j,i,q,r){j||(j=window);if(!i||!i.fn.dataTable)i=require("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/datatables.net")(j,i).$;i.fn.dataTable.Buttons||require("datatables.net-buttons")(j,i);return g(i,j,j.document,q,r)}:g(jQuery,window,document)})(function(g,j,i,q,r,m){function E(a,b){v===m&&(v=-1===y.serializeToString(g.parseXML(F["https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/xl/worksheets/sheet1.xml"])).indexOf("xmlns:r"));
...
f=a("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/xl/worksheets/sheet1.xml"),h=f.getElementsByTagName("sheetData")[0],a={_rels:{".rels":a("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/_rels/.rels")},xl:{_rels:{"https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/workbook.xml.rels":a("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/xl/_rels/workbook.xml.rels")},"https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/workbook.xml":a("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/xl/workbook.xml"),"https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/styles.xml":a("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/xl/styles.xml"),worksheets:{"https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/sheet1.xml":f}},"[Content_Types].xml":a("[Content_Types].xml")},b=b.buttons.exportData(c.exportOptions),j,k,d=function(a){j=e+1;k=o(f,"row",{attr:{r:j}});for(var b=0,c=a.length;b<c;b++){for(var d=b,i="";d>=0;){i=String.fromCharCode(d%26+65)+i;d=Math.floor(d/
...
e++};g("sheets sheet",a.xl["https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/workbook.xml"]).attr("name",Q(c));c.customizeData&&c.customizeData(b);if(c.header){d(b.header,e);g("row c",f).attr("s","2")}for(var i=0,l=b.body.length;i<l;i++)d(b.body[i],e);if(c.footer&&b.footer){d(b.footer,e);g("row:last c",f).attr("s","2")}d=o(f,"cols");g("worksheet",f).prepend(d);i=0;for(l=b.header.length;i<l;i++)d.appendChild(o(f,"col",{attr:{min:i+1,max:i+1,width:N(b,i),customWidth:1}}));c.customize&&c.customize(a);b=new q;d={type:"blob",mimeType:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"};
E(b,a);b.generateAsync?b.generateAsync(d).then(function(a){p(a,x(c))}):p(b.generate(d),x(c))},filename:"*",extension:".xlsx",exportOptions:{},header:!0,footer:!1};s.ext.buttons.pdfHtml5={className:"buttons-pdf buttons-html5",available:function(){return j.FileReader!==m&&r},text:function(a){return a.i18n("https://mannatthemes.com/frogetor/horizontal/assets/plugins/datatables/buttons.pdf","PDF")},action:function(a,b,d,c){K(c);a=b.buttons.exportData(c.exportOptions);b=[];c.header&&b.push(g.map(a.header,function(a){return{text:typeof a==="string"?a:a+"",style:"tableHeader"}}));
