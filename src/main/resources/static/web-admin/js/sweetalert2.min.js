!function (e, t) {
    ...
    var q = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        E = c(["success", "warning", "info", "question", "error"]), d = {previousBodyPadding: null},
        p = function (e, t) {
        ...
        ie = function (e) {
            var t = L();
            if (t && (t.parentNode.removeChild(t), P([document.documentElement, document.body], [D["no-backdrop"], D["has-input"], D["toast-shown"]])), !g()) {
                var n = document.createElement("div");
                n.className = D.container, n.innerHTML = v, ("string" == typeof e.target ? document.querySelector(e.target) : e.target).appendChild(n);
                var o = Z(), r = $(), i = z(r, D.input), a = z(r, D.file),
                    s = r.querySelector("." + D.range + " input"), u = r.querySelector("." + D.range + " output"),
                    l = z(r, D.select), c = r.querySelector("." + D.checkbox + " input"), d = z(r, D.textarea);
            ...
            if (t) {
                ...
                var r = function () {
                    var e, t;
                    document.body.classList.contains(D["toast-shown"]) || (e = window.scrollX, t = window.scrollY, se.restoreFocusTimeout = setTimeout(function () {
    ...
    var k = {
            ...
            useRejections: !1,
            expectRejections: !1
        }, x = ["useRejections", "expectRejections"], B = function (e) {
            return k.hasOwnProperty(e) || "extraParams" === e
        }, T = function (e) {
            return -1 !== x.indexOf(e)
        }, ue = function (e) {
            for (var t in e) B(t) || A('Unknown parameter "' + t + '"'), T(t) && l('The parameter "' + t + '" is deprecated and will be removed in the next major release.')
        },
    ...
    var V = [], le = function () {
            ...
            isValidParameter: B, isDeprecatedParameter: T, argsToParams: function (n) {
                var o = {};
                switch (q(n[0])) {
                    case"string":
            ...
            }, close: w, closePopup: w, closeModal: w, closeToast: w, isVisible: function () {
                return !!Z()
            }, clickConfirm: function () {
                return G().click()
            }, clickCancel: function () {
                return ee().click()
            }, getPopup: Z, getTitle: Y, getContent: $, getImage: J, getButtonsWrapper: function () {
            ...
            }, getActions: te, getConfirmButton: G, getCancelButton: ee, getFooter: ne, isLoading: function () {
            ...
            }, showLoading: le, enableLoading: le, getTimerLeft: function () {
    ...
    function me() {
        var e = fe.innerParams.get(this), t = fe.domCache.get(this);
    ...
    var ve = function (e) {
        var t = L(), n = Z();
        null !== e.onBeforeOpen && "function" == typeof e.onBeforeOpen && e.onBeforeOpen(n), e.animation ? (W(n, D.show), W(t, D.fade), P(n, D.hide)) : P(n, D.fade), U(n), t.style.overflowY = "hidden", y && !p(n, D.noanimation) ? n.addEventListener(y, function e() {
    ...
    var ye = Object.freeze({
        hideLoading: me, disableLoading: me, getInput: function (e) {
            var t = fe.innerParams.get(this), n = fe.domCache.get(this);
            ...
            !function (r) {
                ...
                var e = void 0, t = Z(), n = "string" == typeof r.target ? document.querySelector(r.target) : r.target;
                ...
                for (var o = window.getComputedStyle(e).getPropertyValue("background-color"), i = e.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), a = 0; a < i.length; a++) i[a].style.backgroundColor = o;
                var s = L(), u = Y(), l = $().querySelector("#" + D.content), c = te(), d = G(), p = ee(), f = oe(),
                    m = ne();
                ...
                var g = X(),
                    v = parseInt(null === r.currentProgressStep ? xe.getQueueStep() : r.currentProgressStep, 10);
            ...
            }(j), Object.freeze(j), fe.innerParams.set(this, j), se.timeout && (se.timeout.stop(), delete se.timeout), clearTimeout(se.restoreFocusTimeout);
            var _ = {
                popup: Z(),
                container: L(),
                content: $(),
            ...
            return new Promise(function (t, n) {
                ...
                for (var d = function (t) {
                    ...
                    var t = e || window.event, n = t.target || t.srcElement, o = _.confirmButton, r = _.cancelButton,
                        i = o && (o === n || o.contains(n)), a = r && (r === n || r.contains(n));
                    switch (t.type) {
                        case"click":
                            if (i && V.isVisible()) if (T.disableButtons(), j.input) {
                                var s = function () {
                                    var e = T.getInput();
                                    if (!e) return null;
                                    switch (j.input) {
                            ...
                            } else d(!0); else a && V.isVisible() && (T.disableButtons(), l(V.DismissReason.cancel))
                    }
                }, r = _.popup.querySelectorAll("button"), i = 0; i < r.length; i++) r[i].onclick = e, r[i].onmouseover = e, r[i].onmouseout = e, r[i].onmousedown = e;
                ...
                se.keydownHandlerAdded && (se.keydownTarget.removeEventListener("keydown", se.keydownHandler, {capture: se.keydownListenerCapture}), se.keydownHandlerAdded = !1), j.toast || (se.keydownHandler = function (e) {
                    return function (e, t) {
                        if (t.stopKeydownPropagation && e.stopPropagation(), "Enter" !== e.key || e.isComposing) if ("Tab" === e.key) {
                            for (var n = e.target || e.srcElement, o = re(t.focusCancel), r = -1, i = 0; i < o.length; i++) if (n === o[i]) {
                                r = i;
                                break
                            }
                ...
                switch (j.input) {
                    ...
                    case"file":
                        ...
                        break;
                    case"range":
                        var w = z(_.content, D.range), C = w.querySelector("input"), k = w.querySelector("output");
                    ...
                    case"select":
                        ...
                        b = function (e) {
                            e.forEach(function (e) {
                                var t = M(e, 2), n = t[0], o = t[1], r = document.createElement("option");
                    ...
                    case"radio":
                        ...
                        A.innerHTML = "", b = function (e) {
                            e.forEach(function (e) {
                                var t = M(e, 2), n = t[0], o = t[1], r = document.createElement("input"),
                        ...
                        break;
                    case"checkbox":
                        var E = z(_.content, D.checkbox), P = T.getInput("checkbox");
    ...
    }), we.DismissReason = e, we.noop = function () {
    }, we.version = "7.24.3";
    var Ce, ke, xe = C((Ce = we, ke = function (e) {
        function t() {
            return s(this, t), u(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments))
        }
        ...
        return a(t, Ce), o(t, [{
            ...
            key: "setDefaults", value: function (t) {
                if (l(j), !t || "object" !== (void 0 === t ? "undefined" : q(t))) throw new TypeError("SweetAlert2: The argument for setDefaults() is required and has to be a object");
    ...
    }(), "undefined" != typeof window && "object" === q(window._swalDefaults) && ke.setDefaults(window._swalDefaults), ke));
